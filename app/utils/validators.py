...
def validate_organization_slug(slug: str) -> None:
    ...
    if not re.match(r"^[a-z0-9-]+$", slug):
        raise ValidationError("Organization slug can only contain lowercase letters, numbers, and hyphens")
    ...
    # Reserved slugs
    reserved_slugs = [
        "api", "www", "mail", "admin", "root", "blog", "help", "support",
        "billing", "payments", "auth", "login", "signup", "dashboard",
        "settings", "profile", "account", "organization", "org", "team",
    ]
